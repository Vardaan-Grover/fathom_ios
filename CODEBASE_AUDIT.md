...
- ✅ 🔑 **Leaked Gemini API key removed** from the shared scheme (`GEMINI_API_KEY` in Fathom.xcscheme, git-tracked). **The key must be revoked in Google AI Studio** — it remains in git history.
